...
// Define column names 
$excelData[] = array('EMPLOYEE NUMBER', 'FIRST NAME', 'MIDDLE NAME', 'LAST NAME', 'EXTENSION NAME','FULL NAME', 'POSITION', 'SALARY GRADE','FUND SOURCE','CLASSIFICATION OF STATUS','DIVISION', 'UNIT','TIN'); 

$sql = "SELECT u.empno, u.fname, u.mname, u.sname, u.ename, CONCAT(u.fname,' ',u.mname,' ',u.sname,' ',u.ename) AS fullname, pn.position_name, pos.salary_history_id, fs.fund_source_name, ce.classification_employment_name, d.division_name, un.unit_name, pi.tin_no
FROM userprofile u
...
LEFT JOIN lib_classification_employment ce ON pos.position_classification_id = ce.position_classification_id
WHERE u.emp_status = 0 AND u.position_id !=''
GROUP BY u.empno, u.fname, u.mname, u.sname, u.ename, pn.position_name, pos.salary_history_id, fs.fund_source_name, ce.classification_employment_name, d.division_name, un.unit_name, pi.tin_no";
