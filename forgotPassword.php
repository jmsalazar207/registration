  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="loader-div">
        <img class="loader-img" src="images/ajax-loader.gif" style="height: 50px;width: auto;" />
      </div> 
            ...
            autocomplete="off">
              ...
              <div class="input-group has-feedback">
                ...
                <span class="input-group-addon">
                    <i class="fa glyphicon glyphicon-envelope" 
              ...
              <div class="row">
                <div class="col-xs-12">
                    <div 
                    class="g-recaptcha" 
                    data-callback="recaptchaCallbackForgot" 
                    data-expired-callback="recaptchaExpiredForgot" 
