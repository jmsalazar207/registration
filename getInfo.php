...
require_once("includes/helper.php");
    ...
    oi.q6_details,oi.q7a,oi.q7a_details,oi.q7b,oi.q7b_details,oi.q7c,oi.q7c_details,gi.id,gi.govern_id_title,gi.govern_id_no,gi.govern_id_date,gi.govern_id_place,bd.bank_account_number,bd.bank_account_remarks,bd.bank_account_status
    FROM userprofile up
