...
require_once("includes/helper.php");
    ...
    up.date_registered, up.user_level, up.account_status, pa.id, pa.permNumAdd, pa.permStreet, pa.permSubd, pa.permRegion, pa.permProvince, pa.permCity, pa.permBarangay, pa.permZipCode, 
