 ...
 class CONN_DB{
	...
	private function __construct(){
		try{
			...
			//$this->_pdo = new PDO('mysql:host=172.31.32.64;dbname=registration_staging;charset=utf8', 'remote_user', 'P@ssw0rd1.@ERM');
			//$this->_pdo = new PDO('mysql:host=172.31.32.65;dbname=registration;charset=utf8', 'remote_user', 'P@ssw0rd1.@ERM');
			$this->_pdo = new PDO('mysql:host=localhost;dbname=registration_staging;charset=utf8', 'root', '');
