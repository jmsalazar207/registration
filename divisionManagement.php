...
?>
  ...
  <title>Division Management - Employee's Registration Module</title>
    ...
    <?php 
        ...
        <div class="content-wrapper">
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                <table id="tblDivision" class="table table-bordered table-striped table-responsive" style="text-align:center; width:100%">
