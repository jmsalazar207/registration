(function () {
    ...
    const idleTimeout = 59 * 60 * 1000; // Idle timeout value
    let idleTimer;
    let autoLogoutTimer;
    ...
    function SessionClear() {
        ...
        autoLogoutTimer = setTimeout(logoutUser, 10 * 1000);
    }

    function resetIdleTimer() {
        clearTimeout(idleTimer);
        idleTimer = setTimeout(SessionClear, idleTimeout);
    }
