...
?>
  ...
  <title>Unit Management - Employee's Registration Module</title>
            ...
            <div class="box">
                <div class="box-header">
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="box-title">
                        Management for List of Unit
                      </h3>
                    </div>
                    &nbsp;
                    <div class="col-md-12">
                        <button type="submit" id="btnAdd" name="btnAdd" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addUnit">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                <table id="tblUnit" class="table table-bordered table-striped table-responsive" style="text-align:center; width:100%">
...
<script src="unitManagement.js?test=<?php echo time()?>"></script>
<script>
  $(function () {
