            ...
            <div class="box">
                <div class="box-header">
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="box-title">
                        Verification of Uploaded MOV - Educational Background
                      </h3>
                    </div>
                  </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                <table id="VerifyEduc" class="table table-bordered table-striped table-responsive" style="text-align:center; width:100%">
  ...
  $(function () {
    $('#VerifyEduc').DataTable({
      ...
      columns: [
        ...
        { data: "fullname"},
        { data: "acad_level"},
        { data: "college_school_title"},
        { data: "college_course_title"},
        { data: "acad_period"},
