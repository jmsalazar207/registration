...
?>
  ...
  <title>Name of Position Management - Employee's Registration Module</title>
            ...
            <div class="box">
                <div class="box-header">
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="box-title">
                        Position Name Management Module
                      </h3>
                    </div>
                    &nbsp;
                    <div class="col-md-12">
                        <button type="submit" id="btnAdd" name="btnAdd" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addNewPositionName">
