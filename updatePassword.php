            ...
            autocomplete="off">
              <div class="form-group has-feedback">
                <div class="input-group col-sm-12">
                  ...
                  type="text" 
                  class="form-control" 
                  name="mandatoryUpdateUsername" 
                  id="mandatoryUpdateUsername" 
                ...
                <small id='checkmandatoryUpdateUsername'></small>
              </div>
              <div class="input-group has-feedback"> 
                <input 
                type="password" 
                class="form-control" 
                name="mandatoryUpdateOldPassword" 
                id = "mandatoryUpdateOldPassword" 
                ...
                <span class="input-group-addon">
                  ...
                  data-target="#mandatoryUpdateOldPassword" 
                  role="button" 
                  aria-label="Toggle password visibility">
                  </i>
                </span>
              </div>
              <small id='mandatoryUpdateOldPassword'></small>
              <br>
              <div class="input-group has-feedback">
                <input 
                type="password" 
                class="form-control password-field" 
                name="MandatoryUpdateNewPassword" 
                id = "MandatoryUpdateNewPassword" 
                ...
                <span class="input-group-addon">
                  <i 
                  class="fa fa-eye-slash toggle-password" 
                  data-target="#MandatoryUpdateNewPassword" 
                  role="button" 
                  aria-label="Toggle password visibility">
                  </i>
                </span>
              ...
              <div class="input-group has-feedback">
                ...
                name="MandatoryUpdateConfirmPassword" 
                id = "MandatoryUpdateConfirmPassword" 
                ...
                <span class="input-group-addon">
                  <i 
                  class="fa fa-eye-slash toggle-password" 
                  data-target="#MandatoryUpdateConfirmPassword" 
                  role="button" 
                  aria-label="Toggle password visibility">
                  </i>
                </span>
              </div>
              <small id='CheckMandatoryUpdateConfirmPassword'></small>
              <br>
              <div class="row">
                <div class="col-xs-12">
                    <div 
