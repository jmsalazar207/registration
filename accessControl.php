...
?>
  ...
  <title>Access Control - Employee's Registration Module</title>
...
<script src="accessControl.js?test=<?php echo time()?>"></script>
<script src="modalNotif.js?test=<?php echo time()?>"></script>
<script>
  $(function () {
    tables['tblAccessControl'] = $('#tblAccessControl').DataTable({
      ajax: {
          url: 'accessControl_ajax.php',
          type: 'POST',
          'data': function(data){
          }
        },
