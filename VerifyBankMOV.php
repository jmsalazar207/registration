...
?>
  ...
  <title>Verify Bank Details - Employee's Registration Module</title>
            ...
            <div class="box">
                <div class="box-header">
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="box-title">
                        Verification of Uploaded MOV - Bank Details
                      </h3>
                    </div>
                  </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                <table id="VerifyBankDetails" class="table table-bordered table-striped table-responsive" style="text-align:center; width:100%">
...
?>
<script src="verifyUploadBank.js?test=<?php echo time()?>"></script>
